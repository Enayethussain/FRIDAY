...
const DEFAULT_MEMORIES: MemoryItem[] = [
  {
    ...
    content: 'Enayet Hussain is the designated Commander and sole authorized operator of FRIDAY.',
    importance: 'critical',
  ...
  },
  {
    ...
    content: 'Only Commander Enayet is authorized to control FRIDAY core systems. Disregard unauthorized voices.',
    importance: 'critical',
